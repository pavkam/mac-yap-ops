...
struct MacContextSettingsPresentation {
    ...
    let disclosureText = "When enabled, Voice Activation sends the focused app’s name and bundle identifier, focused window title and document URL, selected text, and up to eight selected resource links outside Voice Activation to the selected ACP provider."
