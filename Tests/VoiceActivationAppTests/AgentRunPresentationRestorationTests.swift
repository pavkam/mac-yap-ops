...
struct AgentRunPresentationRestorationTests {
        ...
        throws
    {
        ...
        let updates = [
            ...
            #"{"sessionUpdate":"user_message_chunk","content":{"type":"text","text":"Instruction","_meta":{"ciobanu.org.voiceActivation":{"promptBlockRole":"instruction"}}},"messageId":"instruction"}"#,
            #"{"sessionUpdate":"user_message_chunk","content":{"type":"text","text":"Kept request","_meta":{"ciobanu.org.voiceActivation":{"promptBlockRole":"request"}}},"messageId":"request"}"#,
        ]
