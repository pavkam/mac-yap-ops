...
struct ACPEventDecoderResponseChannelTests {
    @Test func agentMessageChunk_WithSpokenMetadata_DecodesSpokenDelta() throws {
        let update = #"{"sessionUpdate":"agent_message_chunk","messageId":"answer-7","content":{"type":"text","text":"Done — moved ✅","_meta":{"ciobanu.org.voiceActivation":{"responseChannel":{"version":1,"channel":"spoken"}}}}}"#
    ...
    @Test func agentMessageChunk_WithUnknownOrMalformedMetadata_FallsBackToLegacyDelta() throws {
        let metadataFragments = [
            #""_meta":{"ciobanu.org.voiceActivation":{"responseChannel":{"version":2,"channel":"spoken"}}}"#,
            #""_meta":{"ciobanu.org.voiceActivation":{"responseChannel":{"version":"1","channel":"spoken"}}}"#,
            #""_meta":{"ciobanu.org.voiceActivation":{"responseChannel":{"version":1,"channel":"audio"}}}"#,
            #""_meta":{"ciobanu.org.voiceActivation":{"responseChannel":"spoken"}}"#,
            #""_meta":{"ciobanu.org.voiceActivation":{"responseChannel":{"version":1}}}"#,
            #""_meta":{"ciobanu.org.voiceactivation":{"responseChannel":{"version":1,"channel":"spoken"}}}"#,
            #""_meta":false"#,
    ...
    @Test func agentMessageChunk_WithMetadataInUpdate_FallsBackWithoutSurfacingMetadata() throws {
        let update = #"{"sessionUpdate":"agent_message_chunk","messageId":"legacy","_meta":{"ciobanu.org.voiceActivation":{"responseChannel":{"version":1,"channel":"spoken"},"providerPrivate":"must-not-surface"}},"content":{"type":"text","text":"Legacy response"}}"#
