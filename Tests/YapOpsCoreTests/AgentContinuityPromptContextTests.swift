...
struct AgentContinuityPromptContextTests {
    ...
    @Test func previousTurnInterruptedInNormalSession_EncodesHonestNullState() throws {
        ...
        {"previousTurnInterrupted":true,"schema":"yapops.agent-continuity.v1","sessionState":null}
        """)
    ...
    @Test(arguments: [
        """
        {"previousTurnInterrupted":false,"schema":"yapops.agent-continuity.v1","sessionState":null}
        """,
        """
        {"previousTurnInterrupted":false,"schema":"yapops.agent-continuity.v1"}
        """,
    ])
