...
struct ACPClientConnectionSteeringTests {
            ...
            params: .object([
                ...
                "prompt": .array([
                    ...
                    ACPClientConnection.encodedPromptBlock(for: .text(
                        ...
                        {"application":{"bundleIdentifier":"com.example.Editor","name":"Editor"},"captureState":"complete","documentURL":"https://example.test/document","resources":[{"name":"notes.md","uri":"file:///tmp/notes.md"}],"schema":"yapops.mac-context.v1","selectedText":"Selected words","truncatedFields":[],"windowTitle":"Notes"}
                        """)),
    ...
    private final class SteeringResponseCancellation: YapOpsDiagnosticRecording,
        @unchecked Sendable
    {
