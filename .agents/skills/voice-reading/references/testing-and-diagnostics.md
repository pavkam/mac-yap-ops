...
| Spoken replies keep creating follow-ups | Every nonempty recognition result during playback was admitted as barge-in | Pause hands-free capture for every non-idle speech state; retire late callbacks; use explicit push-to-talk interruption. Guard coordinator echo and audio output-state tests. |
