...
| Stop cancels but a new reply starts immediately | Pending follow-ups or partial recognition survived cancellation | Retire recognition and execution, discard pending input before publishing cancellation, and assert no next prompt starts. Guard with coordinator cancellation tests. |
